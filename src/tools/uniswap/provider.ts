...
import { Environment, CurrentConfig } from "@/config/uniswap";
...
async function sendTransactionViaExtension(transaction: ethers.providers.TransactionRequest): Promise<TransactionState> {
  try {
