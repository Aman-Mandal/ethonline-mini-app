    ...
    <main className='flex flex-col gap-4'>
      ...
      <div className='flex items-center gap-4 w-full'>
        <div className='bg-[#111111] p-8 rounded-md text-white w-[50%]'>
          ...
          <p className='text-xs text-[#979797]'>
            Bridge 20 USDT from Linea to Scroll using our smart intent based
            mini app for smoother and secure briding experience
          </p>
        </div>
        ...
        <div className='bg-[#111111] p-8 rounded-md text-white w-[50%]'>
          ...
          <p className='text-xs text-[#979797]'>
            Swap 10 USDC with 10 DAI on Hedera chain using our decentralized
            exchange for fast and secure transactions
          </p>
        </div>
      </div>
      ...
      <div className='flex items-center gap-4 w-full'>
        <div className='bg-[#111111] p-8 rounded-md text-white w-[50%]'>
          ...
          <p className='text-xs text-[#979797]'>
            Stake tokens crosschain using Chainlink&apos;s CCIP and improve your
            experience of smart staking with our telegram mini app
          </p>
        </div>
